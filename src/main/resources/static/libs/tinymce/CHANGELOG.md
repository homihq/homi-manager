# Changelog
All notable changes to this deploymentTarget will be documented in this file.

The format is based on [Keep a Changelog](https://keepachangelog.com/en/1.0.0/),
and this deploymentTarget adheres to [Semantic Versioning](https://semver.org/spec/v2.0.0.html).
...
- Nuget packages for .NET and .NET Core are now configured to copy TinyMCE into `/wwwroot/lib/` when TinyMCE is installed into a deploymentTarget. #TINY-8611
